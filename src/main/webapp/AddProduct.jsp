...
<body>
	<div class="container">
      ...
      <div class="row d-flex">
        <div class="col-md-6 ">
          <div class="card flex-md-row mb-4 box-shadow h-md-250 shadow-lg p-3 mb-5 bg-white rounded">
            <div class="card-body d-flex flex-column align-items-start">
              <h3 class="mb-0">
                <a class="text-dark" href="AddProduct.jsp">Add Product</a>
              </h3>
              	<div class="product ">
			  	 <form action="isAddProd" id="frm" name="frm" method="get" class="abcd mt-1"  >
			  	 
       				 	<label><b><h5>Add Product</h5></b></label><br>
				        <input type="text" placeholder="Enter Product Name" id="txtprod" name="productName" onkeyup="checkProdName(this.value)"
				        	required style="width: 400px; height: 40px;"><br>
				        <label><b><h5>Add Category</h5></b></label><br>
				        <input type="text" placeholder="Enter Product Category" name="catName" onkeyup="checkProdCate(this.value)"
				        	required style="width: 400px; height: 40px;"><br>
				        <label><b><h5>Enter Price</h5></b></label><br>
				        <input type="text" placeholder="Enter Product Price" name="price" 
				        	required style="width: 400px; height: 40px;"> <br><br>
				       <b><input type="submit" name="s"  value="Add Product" required style="width: 400px; height: 40px; padding-right: 40px;"></b> 
				    </form>
			  	</div>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250 h-14">
				<img alt="" class="img-thumbnail" src="Imgs/man.png">
          </div>
        </div>
      </div>
