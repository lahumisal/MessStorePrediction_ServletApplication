...
<body>
      ...
      <div class="nav-scroller py-1 mb-2 bg-warning">
        ...
        <nav class="nav d-flex justify-content-between">
          <a class="p-2 text-dark h6 " href="maintainProd.jsp"></a>
          <a class="p-2 text-dark h6 " href="maintainProdBydate.jsp">Date wise data</a>
          <a class="p-2 text-dark h6 " href="maintainProdByMonth.jsp">Month wise data</a>
          <a class="p-2 text-dark h6 " href="maintainProdByYear.jsp">Year wise data</a>
        </nav>
      </div>
