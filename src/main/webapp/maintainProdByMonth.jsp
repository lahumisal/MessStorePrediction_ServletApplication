...
<head>
    ...
    <script>
        function fetchMonthWiseData() {
            ...
            window.location.href = "maintainProdByMonth.jsp?month=" + selectedMonth;
        }
    </script>
</head>
<body>
        ...
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250 shadow-lg p-3 mb-5 bg-white rounded">
                <div class="card-body d-flex flex-column align-items-start">
                    <h3 class="mb-0">
                        <a class="text-dark" href="maintainProdByMonth.jsp">All Product List Month Wise</a>
                    </h3>
                    ...
                    <%
                        ...
                        if (month != null) {
                            ...
                            List<MaintainPerchessModel> Listmodel = listserv.isMonthWiseData(month);
                            if (Listmodel != null) {
                    %>
