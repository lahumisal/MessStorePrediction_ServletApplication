      ...
      <div class="row mb-2 d-flex align-items-center justify-content-center">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250 ">
            <div class="card-body d-flex flex-column align-items-start shadow-lg p-3 mb-5 bg-white rounded">
              <h3 class="mb-0">
                <a class="text-dark" href="viewProod.jsp">Product List</a>
              </h3>
              <div class="mb-1 text-muted">Nov 12</div>
			  	...
			  	<%! AddProductService listserv=new AddProductServiceImpl();%>
			  	<% List<ViewProdListModel> model=listserv.ViewProdList(); %>
			  	<div  class="tab" >
					  		<input type="text" id="myInput" onkeyup="searchUsingAjax(this.value)" placeholder="Search for names.." title="Type in a name"><br>
					    </div >
								...
								<table class="table">
									<thead class="thead-dark" >
										<tr>
											...
											<th scope="col" align="center">Delete Product</th>
											<th scope="col" align="center">Update Price</th>
										</tr>
									</thead>
									<tbody>
										<% int count = 0;
										for (ViewProdListModel m : model) {
											count++;
										int price=	m.getProd_price();
										
										%>
										<tr class="header row-hover bg-white" >
											<th scope="row"><%=count%></th>
											<td align="center"><%=m.getProd_name()%></td>
											<td align="center"><%=m.getProd_cat()%></td>
											<td align="center"><%=m.getProd_price()%></td>
											<td align="center"><button type="button" class="btn btn-danger">
											<a class="text-white" href="delProd?delId=<%=m.getProd_id()%>">Delete</a></button></td>
											<td align="center"><button type="button" class="btn btn-success">
											 <a class="text-white" href='updateprod.jsp?uId=<%= m.getProd_id() %>&item2=<%= price %>'>Update</a>
