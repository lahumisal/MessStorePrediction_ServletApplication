...
<head>
<meta charset="UTF-8">
<title>Year Wise Stock</title>
<script>
        function fetchYearWiseData() {
            var selectedYear = document.getElementById("yearSelect").value;
            window.location.href = "yearWiseStock.jsp?year=" + selectedYear;
        }
    </script>
        ...
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250 shadow-lg p-3 mb-5 bg-white rounded">
                <div class="card-body d-flex flex-column align-items-start">
                    <h3 class="mb-0">
                        <a class="text-dark" href="yearWiseStock.jsp">All Product Stock List Year Wise</a>
                    </h3>
                    ...
                    <%
                        ...
                        if (year != null) {
                            ...
                            List<viewStockListModel> Listmodel = list.isViewYearWiseStock(Integer.parseInt(year));
                            if (Listmodel != null) {
                    %>
